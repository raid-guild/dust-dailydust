...
// equivalent to WorldResourceIdLib.encode({ typeId: RESOURCE_SYSTEM, namespace: "rg_dd_0002", name: "BaseProgram" }))
BaseProgramType constant baseProgram = BaseProgramType.wrap(
  0x737972675f64645f30303032000000004261736550726f6772616d0000000000
);
