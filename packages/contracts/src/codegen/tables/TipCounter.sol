...
library TipCounter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "thedailydust", name: "TipCounter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627468656461696c79647573740000546970436f756e746572000000000000);
