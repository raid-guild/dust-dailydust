...
library Creators {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "thedailydust", name: "Creators", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627468656461696c7964757374000043726561746f72730000000000000000);
