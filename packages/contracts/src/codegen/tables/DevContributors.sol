...
library DevContributors {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "thedailydust", name: "DevContributors", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627468656461696c79647573740000446576436f6e7472696275746f727300);
   ...
   * @notice Get value.
   */
  function getValue() internal view returns (address[] memory value) {
   ...
   * @notice Get value.
   */
  function _getValue() internal view returns (address[] memory value) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get value.
   */
  function get() internal view returns (address[] memory value) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get value.
   */
  function _get() internal view returns (address[] memory value) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set value.
   */
  function setValue(address[] memory value) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set value.
   */
  function _setValue(address[] memory value) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set value.
   */
  function set(address[] memory value) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set value.
   */
  function _set(address[] memory value) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function getItemValue(uint256 _index) internal view returns (address) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItemValue(uint256 _index) internal view returns (address) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function pushValue(address _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Push an element to value.
   */
  function _pushValue(address _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function updateValue(uint256 _index, address _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Update an element of value at `_index`.
   */
  function _updateValue(uint256 _index, address _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
