...
library Editors {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "thedailydust", name: "Editors", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627468656461696c79647573740000456469746f7273000000000000000000);
