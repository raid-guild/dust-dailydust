...
library IsEditorPublication {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "thedailydust", name: "IsEditorPublicat", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627468656461696c796475737400004973456469746f725075626c69636174);
