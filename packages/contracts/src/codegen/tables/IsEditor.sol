...
library IsEditor {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "thedailydust", name: "IsEditor", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627468656461696c796475737400004973456469746f720000000000000000);
