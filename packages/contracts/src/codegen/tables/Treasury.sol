...
library Treasury {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "thedailydust", name: "Treasury", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74627468656461696c7964757374000054726561737572790000000000000000);
