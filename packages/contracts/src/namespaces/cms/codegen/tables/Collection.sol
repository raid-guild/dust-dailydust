...
library Collection {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "cms", name: "Collection", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462636d730000000000000000000000436f6c6c656374696f6e000000000000);

  FieldLayout constant _fieldLayout =
    FieldLayout.wrap(0x0026050414080801010000000000000000000000000000000000000000000000);

  // Hex-encoded key schema of (bytes32)
  Schema constant _keySchema = Schema.wrap(0x002001005f000000000000000000000000000000000000000000000000000000);
  // Hex-encoded value schema of (address, uint64, uint64, uint8, uint8, string, string, string, string)
  Schema constant _valueSchema = Schema.wrap(0x002605046107070000c5c5c5c500000000000000000000000000000000000000);
  ...
  function getFieldNames() internal pure returns (string[] memory fieldNames) {
    ...
    fieldNames[3] = "collectionType";
    fieldNames[4] = "featured";
    fieldNames[5] = "title";
    fieldNames[6] = "description";
    fieldNames[7] = "headerImageUrl";
    fieldNames[8] = "extra";
  }
  ...
  /**
   * @notice Get collectionType.
   */
  function getCollectionType(bytes32 collectionId) internal view returns (uint8 collectionType) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = collectionId;
   ...
   * @notice Get collectionType.
   */
  function _getCollectionType(bytes32 collectionId) internal view returns (uint8 collectionType) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = collectionId;
  ...
  /**
   * @notice Set collectionType.
   */
  function setCollectionType(bytes32 collectionId, uint8 collectionType) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = collectionId;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((collectionType)), _fieldLayout);
  }

  /**
   * @notice Set collectionType.
   */
  function _setCollectionType(bytes32 collectionId, uint8 collectionType) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = collectionId;

    StoreCore.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((collectionType)), _fieldLayout);
  }

  /**
   * @notice Get featured.
   */
  function getFeatured(bytes32 collectionId) internal view returns (uint8 featured) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = collectionId;
   ...
   * @notice Get featured.
   */
  function _getFeatured(bytes32 collectionId) internal view returns (uint8 featured) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = collectionId;
   ...
   * @notice Set featured.
   */
  function setFeatured(bytes32 collectionId, uint8 featured) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = collectionId;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((featured)), _fieldLayout);
  }

  /**
   * @notice Set featured.
   */
  function _setFeatured(bytes32 collectionId, uint8 featured) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = collectionId;

    StoreCore.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((featured)), _fieldLayout);
  }
  ...
  function set(
    ...
    bytes memory _staticData = encodeStatic(owner, createdAt, updatedAt, collectionType, featured);
  ...
  function decodeStatic(
    bytes memory _blob
  ) internal pure returns (address owner, uint64 createdAt, uint64 updatedAt, uint8 collectionType, uint8 featured) {
    ...
    collectionType = (uint8(Bytes.getBytes1(_blob, 36)));

    featured = (uint8(Bytes.getBytes1(_blob, 37)));
  }
  ...
  function decode(
    ...
    (_table.owner, _table.createdAt, _table.updatedAt, _table.collectionType, _table.featured) = decodeStatic(
      _staticData
    );
  ...
  function encodeStatic(
    ...
    return abi.encodePacked(owner, createdAt, updatedAt, collectionType, featured);
  }
