...
import { BaseProgram } from "../../systems/BaseProgram.sol";
...
// equivalent to WorldResourceIdLib.encode({ typeId: RESOURCE_SYSTEM, namespace: "cms", name: "BaseProgram" }))
BaseProgramType constant baseProgram = BaseProgramType.wrap(
  0x7379636d7300000000000000000000004261736550726f6772616d0000000000
);
